                    ...
                    <div class="slider-text-middle-main">
                        <div class="slider-text-bottom">
                            <div class="col-12 text-center">
                                <h4 class="text-white-2 alt-font font-weight-300 width-60 mx-auto margin-ten-bottom lg-margin-fifteen-bottom lg-width-80 md-margin-twenty-bottom sm-width-100 sm-margin-100px-bottom">Single <strong>post</strong> page</h4>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-12 breadcrumb alt-font text-small">
                ...
                <ul>
                    ...
                    <li><a href="#" class="text-medium-gray">Blog</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-10 mx-auto text-center last-paragraph-no-margin">
                <h5 class="alt-font text-extra-dark-gray font-weight-600 mb-0">We must let go of the life we have planned, so as to accept the one that is waiting for us.</h5>
                <img src="http://placehold.it/1000x667" alt="" class="width-100 margin-40px-tb md-margin-30px-tb">
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of letraset sheets containing lorem ipsum passages, and more recently with desktop publishing software like Aldus pagemaker including versions of Lorem Ipsum.</p>
            </div>
            <div class="col-12 col-lg-10 mx-auto text-center last-paragraph-no-margin">
                <img src="http://placehold.it/1000x667" alt="" class="width-100 margin-40px-tb md-margin-30px-tb">
                <p class="text-large text-extra-dark-gray">Today I choose life. Every morning when I wake up I can choose joy, happiness, negativity, pain... To feel the freedom that comes from being able to continue to make mistakes and choices - today I choose to feel life, not to deny my humanity but embrace it.</p>
            ...
            <div class="col-12 col-lg-10 mx-auto text-center margin-60px-tb md-margin-30px-tb">
                <div class="bg-light-gray padding-ten-all md-padding-35px-all sm-padding-25px-all">
                    ...
                    <h5 class="alt-font text-extra-dark-gray font-weight-600">This is an excellent company! I personally enjoyed the energy and the professional support the whole team gave to us into creating website.</h5>
                    <span class="text-uppercase text-extra-small alt-font letter-spacing-3 text-medium-gray">Mattie Stepanek</span>
                </div>
            </div>
            <div class="col-12 col-lg-10 mx-auto text-center margin-60px-bottom last-paragraph-no-margin md-margin-30px-bottom">
                <img src="http://placehold.it/1000x667" alt="" class="width-100 margin-40px-bottom md-margin-30px-bottom">
                <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-lg-10 d-flex flex-wrap mx-auto">
                <div class="col-12 col-lg-6 pl-0 md-no-padding-lr md-margin-30px-bottom text-center last-paragraph-no-margin">
                    <div class="bg-light-gray padding-50px-all md-padding-25px-all">
                        <span class="text-medium font-weight-600 text-extra-dark-gray alt-font">Young man with beard and piercings</span>
                        <img src="http://placehold.it/800x533" alt="" class="width-100 margin-30px-tb">
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                    </div>
                </div>
                <div class="col-12 col-lg-6 pl-0 md-no-padding-lr text-center last-paragraph-no-margin">
                    <div class="bg-light-gray padding-50px-all md-padding-25px-all">
                        <span class="text-medium font-weight-600 text-extra-dark-gray alt-font">Latin man with beard and piercings</span>
                        <img src="http://placehold.it/800x533" alt="" class="width-100 margin-30px-tb">
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                    </div>
                </div>
...
<section class="wow fadeIn bg-light-gray">
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- end post item -->
            <!-- start post item -->
            <div class="col-12 col-lg-3 col-md-6 last-paragraph-no-margin md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp" data-wow-delay="0.2s">
                <div class="blog-post blog-post-style1 text-center text-md-left">
                    <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
            ...
            <!-- end post item -->
            <!-- start post item -->
            <div class="col-12 col-lg-3 col-md-6 last-paragraph-no-margin sm-margin-30px-bottom wow fadeInUp" data-wow-delay="0.4s">
                <div class="blog-post blog-post-style1 text-center text-md-left">
                    <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
            ...
            <div class="col-12 col-lg-3 col-md-6 last-paragraph-no-margin wow fadeInUp" data-wow-delay="0.6s">
                <div class="blog-post blog-post-style1 text-center text-md-left">
                    ...
                    <div class="post-details">
                        <span class="post-author text-extra-small text-medium-gray text-uppercase d-block margin-10px-bottom sm-margin-5px-bottom">02 June 2017 | by <a href="blog-masonry.html" class="text-medium-gray">Jennifer Freeman</a></span>
                        <a href="blog-post-layout-04.html" class="post-title text-medium text-extra-dark-gray width-90 d-block md-width-100">I wish someone would ask me to design a cathedral.</a>
                        <div class="separator-line-horrizontal-full bg-medium-light-gray margin-20px-tb md-margin-15px-tb"></div>
                        <p class="width-90 sm-width-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum text...</p>
                    </div>
                </div>
